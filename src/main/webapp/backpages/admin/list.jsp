...
<div id="dcWrap">
 ...
 <div id="dcMain">
   <!-- 当前位置 -->
<div id="urHere">BBS 管理中心<b>></b><strong>网站管理员</strong> </div>  
 <div id="manager" class="mainBox" style="height:auto!important;height:550px;min-height:550px; ">
    <h3><a href="root_addUI.action" class="actionBtn">添加管理员</a>网站管理员</h3>
     ...
     <s:iterator value="#users" var="user">
     	 ...
     	 <td align="center"><a href="root_editUI.action?id=${user.id }">编辑</a> | <a href="root_delete.action?id=${user.id }">删除</a></td>
     	</tr>
     </s:iterator>
         </table>
                       </div>
